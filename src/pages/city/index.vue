<template>
  <div class="city_body">
      ...
      <div class="content_city">
        ...
        <div class="city_list">
          <div class="city_list_item" v-for="(item,index) in cityList" :key="index">
            ...
            <div class="city_list_name" v-for="(item1,index1) in item.list" :key="index1">
              <div class="city_list_name_item">{{item1.nm}}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="city_list_index">
      <div class="index_item" v-for="(item,index) in cityList" :key="index">{{item.index}}</div>
    </div>
  </div>
</template>
<script>
...
export default {
    ...
    methods:{
        ...mapActions({
            getCityHandler:"City/getCityHandler",
        }),
    }
